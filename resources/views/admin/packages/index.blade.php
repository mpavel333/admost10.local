																	...
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="<?php echo route('admin.packages.edit',$Package->id) ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6"><?php echo $Package->name_ru ?></a>
																				<span class="text-gray-400 fw-semibold d-block fs-7"><?php echo $Package->alias ?> </span>
																			</div>
																		</div>
																	</td>
...
<?php
        ...
        switch ($Package->published) {
            case 0:
                 echo '<span class="badge py-3 px-4 fs-7 badge-light-primary">Disable</span>'; 
            break;                                                                    
            case 1:
                 echo '<span class="badge py-3 px-4 fs-7 badge-light-success">Published</span>'; 
            break;                                                                    
        }    
...
?>
																	...
																	<td class="text-end">
																		<a href="<?php echo route('admin.packages.edit',$Package->id) ?>" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
