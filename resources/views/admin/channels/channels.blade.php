														...
														<table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
															...
															<thead>
																<tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
																	...
																	<th class="p-0 pb-3 min-w-175px text-end pe-12">TG STATUS</th>
																	...
																	<td>
																		<div class="d-flex align-items-center">
																			<div class="symbol symbol-50px me-3">
																				<img src="metronik/assets/media/stock/600x600/img-49.jpg" class="" alt="" />
																			</div>
																			<div class="d-flex justify-content-start flex-column">
																				<a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6"><?php echo $channel->name ?></a>
																				<span class="text-gray-400 fw-semibold d-block fs-7"><?php echo $channel->link ?> </span>
																			</div>
																		</div>
																	</td>
...
<?php
        ...
        switch ($channel->tg_status) {
            case 0:
                 echo '<span class="badge py-3 px-4 fs-7 badge-light-primary">In Process</span>'; 
            break;                                                                    
            case 1:
                 echo '<span class="badge py-3 px-4 fs-7 badge-light-success">Complated</span>'; 
            break;                                                                    
            case 2:
                 echo '<span class="badge py-3 px-4 fs-7 badge-light-warning">Cancel</span>'; 
            break;                                                                    
        }    
...
?>
																	...
																	<td class="text-end">
																		<a href="<?php echo route('admin.channels.edit',$channel->id) ?>" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
