																	...
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				<a href="<?php echo route('admin.pages.edit',$Page->id) ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6"><?php echo $Page->name_ru ?></a>
																				<span class="text-gray-400 fw-semibold d-block fs-7"><?php echo $Page->alias ?> </span>
																			</div>
																		</div>
																	</td>
...
?>
																	...
																	<td class="text-end">
																		<a href="<?php echo route('admin.pages.edit',$Page->id) ?>" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
