        ...
        <div class="panel-inner">
            ...
            @endif                    
                    <div class="channels">
                        ...
                        <div class="ch-col">
                            <a href="{{ route('user.channels.channel',$channel->id) }}" class="channel-btn">
                                <div class="icon">
...
<div class="d-flex flex-column">
    ...
    <span>Пожалуйста добавьте нашего бота <a href="https://t.me/admost333_bot" target="_blank">@admost333_bot</a> в администраторы вашего канала и нажмите <a href="<?php echo route('user.channels.check_tg_status') ?>" class="btn btn-secondary me-2 mb-2">Подтвердить права</a></span>
</div>
</div>                    
